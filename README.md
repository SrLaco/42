...
This project has been created as part of the 42 curriculum by cade-mou, and whoever wants to fork it.

With this project i envision to get, step by step, the optimal form of every project and every milestone for the python course ate 42.
